...
TOKEN = "<5607176570:AAExA0KUppuU-BVcV2_3BLuHgwLnLnGXqtQ>"
...
def tel_send_message(chat_id, text):
    url = f'https://api.telegram.org/bot{5607176570:AAExA0KUppuU-BVcV2_3BLuHgwLnLnGXqtQ}/sendMessage'
    payload = {
        'chat_id': chat_id,
        'text': text
    }
...
def tel_send_image(chat_id):
    url = f'https://api.telegram.org/bot{5607176570:AAExA0KUppuU-BVcV2_3BLuHgwLnLnGXqtQ}/sendPhoto'
    payload = {
        'chat_id': chat_id,
...
def tel_send_poll(chat_id):
    url = f'https://api.telegram.org/bot{5607176570:AAExA0KUppuU-BVcV2_3BLuHgwLnLnGXqtQ}/sendPoll'
    payload = {
        'chat_id': chat_id,
...
def tel_send_audio(chat_id):
    url = f'https://api.telegram.org/bot{5607176570:AAExA0KUppuU-BVcV2_3BLuHgwLnLnGXqtQ}/sendAudio'
...
def tel_send_document(chat_id):
    url = f'https://api.telegram.org/bot{5607176570:AAExA0KUppuU-BVcV2_3BLuHgwLnLnGXqtQ}/sendDocument'
...
def tel_send_video(chat_id):
    url = f'https://api.telegram.org/bot{5607176570:AAExA0KUppuU-BVcV2_3BLuHgwLnLnGXqtQ}/sendVideo'
...
def tel_upload_file(file_id):
    ...
    url = f'https://api.telegram.org/bot{5607176570:AAExA0KUppuU-BVcV2_3BLuHgwLnLnGXqtQ}/getFile?file_id={file_id}'
    a = requests.post(url)
    ...
    url_1 = f'https://api.telegram.org/file/bot{5607176570:AAExA0KUppuU-BVcV2_3BLuHgwLnLnGXqtQ}/{file_pathh}'
